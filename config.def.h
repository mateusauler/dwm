...
static const Rule rules[] = {
	...
	{ "qBittorrent",              NULL,       NULL,           1 << 2,   1,         0,          0,          -1,        -1 },
...
//static const char *dmenucmd[]   = { "dmenu_run", "-wd", "900", "-m", dmenumon, "-fn", dmenufont, "-nb",  normbgcolor, "-nf", normfgcolor, "-sb", selbordercolor, "-sf", selfgcolor, NULL };
static const char *dmenucmd[]   = { "dmenu_run", "-wd", "900", "-m", dmenumon, NULL };
